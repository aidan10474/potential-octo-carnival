    ...
    public class PersistentSupportSQLServer : PersistentSupport
    {
        ...
        public override void transferMSMQLog(bool all)
        {
            ...
            if (!all && Configuration.MaxLogRowDays > 0)
            {
                ...
                filterMQQueues.LesserOrEqual("PRJMQQueues_History", "DATASTATUS", lastDate);
            }
                ...
                using (System.Data.SqlClient.SqlTransaction logTransaction = (System.Data.SqlClient.SqlTransaction)this.Connection.BeginTransaction())
                {
                    try
                    {
                        ...
                        SelectQuery query = new SelectQuery()
                            .Select("PRJMQQueues_History", "CODMQQUEUES", "CODMQQUEUES")
                            .Select("PRJMQQueues_History", "QUEUEID", "QUEUEID")
							.Select("PRJMQQueues_History", "CHANNELID", "CHANNELID")
                            .Select("PRJMQQueues_History", "ANO", "ANO")
                            .Select("PRJMQQueues_History", "USERNAME", "USERNAME")
                            .Select("PRJMQQueues_History", "TABELA", "TABELA")
                            .Select("PRJMQQueues_History", "TABELACOD", "TABELACOD")
                            .Select("PRJMQQueues_History", "QUEUEKEY", "QUEUEKEY")
                            .Select("PRJMQQueues_History", "QUEUE", "QUEUE")
                            .Select("PRJMQQueues_History", "MQSTATUS", "MQSTATUS")
                            .Select("PRJMQQueues_History", "DATASTATUS", "DATASTATUS")
                            .Select("PRJMQQueues_History", "DATACRIA", "DATACRIA")
                            .Select("PRJMQQueues_History", "OPERACAO", "OPERACAO")
                            .Select("PRJMQQueues_History", "RESPOSTA", "RESPOSTA")
                            .Select("PRJMQQueues_History", "SENDNUMBER", "SENDNUMBER")
                            .Select("PRJMQQueues_History", "ZZSTATE", "ZZSTATE")
                            .From("PRJMQQueues_History")
                            .Where(filterMQQueues)
                            .OrderBy("PRJMQQueues_History", "DATACRIA", Quidgest.Persistence.GenericQuery.SortOrder.Ascending);
                        ...
                        using (IDataReader dr = command.ExecuteReader())
                        {
                            ...
                            using (System.Data.SqlClient.SqlBulkCopy bulkCopy = new System.Data.SqlClient.SqlBulkCopy(
                                ...
                                logTransaction))
                            {
                                bulkCopy.DestinationTableName = "dbo.PRJMQQueues_History";
