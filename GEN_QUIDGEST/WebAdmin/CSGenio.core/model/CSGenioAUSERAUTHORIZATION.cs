...
namespace CSGenio.business
{
	...
	public class CSGenioAuserauthorization : DbArea
	{
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.ParentTables.Add("psw", new Relation("PRJ", "userauthorization", "userauthorization", "codua", "codpsw", "PRJ", "userlogin", "psw", "codpsw", "codpsw"));
		...
		// USE /[MANUAL PRJ TABAUX UserAuthorization]/
