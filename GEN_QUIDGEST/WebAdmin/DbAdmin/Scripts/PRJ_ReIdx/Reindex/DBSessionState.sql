...
SET @SQL = N'
CREATE DATABASE [ASPStatePRJ]
 CONTAINMENT = NONE
 ON  PRIMARY 
	(NAME = N''ASPStatePRJ'', FILENAME = N''' + @SQLDataFolder + 'ASPStatePRJ.mdf'' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB ), 
 FILEGROUP [ASPStatePRJ_mod] CONTAINS MEMORY_OPTIMIZED_DATA  DEFAULT
	(NAME = N''ASPStatePRJ_mod'', FILENAME = N''' + @SQLLogFolder + 'ASPStatePRJ_mod'' , MAXSIZE = UNLIMITED)
 LOG ON 
	(NAME = N''ASPStatePRJ_log'', FILENAME = N''' + @SQLLogFolder + 'ASPStatePRJ_log.ldf'' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB );

ALTER DATABASE [ASPStatePRJ] SET COMPATIBILITY_LEVEL = 130; ALTER DATABASE [ASPStatePRJ] SET MEMORY_OPTIMIZED_ELEVATE_TO_SNAPSHOT=ON;'
