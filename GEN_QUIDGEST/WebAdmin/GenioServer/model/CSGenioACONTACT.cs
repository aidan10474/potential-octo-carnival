...
namespace CSGenio.business
{
	...
	public class CSGenioAcontact : DbArea
	{
		...
		public CSGenioAcontact(User user, string module)
		{
            this.user = user;
            this.module = module;
			// USE /[MANUAL PRJ CONSTRUTOR CONTACT]/
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "gdgdg", FieldType.TEXT);
			Qfield.FieldDescription = "gdgdg";
			Qfield.FieldSize =  50;
			Qfield.MQueue = false;
			Qfield.CavDesignation = "GDGDG25930";
		...
		public static FieldRef FldGdgdg { get { return m_fldGdgdg; } }
		private static FieldRef m_fldGdgdg = new FieldRef("contact", "gdgdg");

		/// <summary>Field : "gdgdg" Tipo: "C" Formula:  ""</summary>
		public string ValGdgdg
		{
			get { return (string)returnValueField(FldGdgdg); }
			set { insertNameValueField(FldGdgdg, value); }
		}
