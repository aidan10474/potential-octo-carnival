<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-f-skill-player-player-name-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['F_SKILL_PLAYER__PLAYER__NAME_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FSkillPlayerPlayerNameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('F_SKILL_PLAYER__PLAYER__NAME_SeeMore', false),

				interfaceMetadata: {
					id: 'F_SKILL_PLAYER__PLAYER__NAME_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'F_SKILL_PLAYER__PLAYER__NAME_SeeMore',
					name: 'F_SKILL_PLAYER__PLAYER__NAME_SeeMore',
					controller: 'SKILL_PLAYER',
					action: 'F_SKILL_PLAYER_PlayerValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-f-skill-player-player-name',
				dismissAction: this.close,
				returnElement: 'F_SKILL_PLAYER__PLAYER__NAME_see-more_button'
			}
			const props = {
				class: 'q-dialog-see-more',
				title: computed(() => this.Resources.PLAYERS11892),
				buttons: [
					{
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-f-skill-player-player-name')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'F_skill_player_PlayerValName',
							serverMode: true,
						...
						uuid: 'F_skill_player_F_skill_player_PlayerValName',
