<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-f-player-stats-player-name-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['F_PLAYER_STATS__PLAYER__NAME_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FPlayerStatsPlayerNameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('F_PLAYER_STATS__PLAYER__NAME_SeeMore', false),

				interfaceMetadata: {
					id: 'F_PLAYER_STATS__PLAYER__NAME_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'F_PLAYER_STATS__PLAYER__NAME_SeeMore',
					name: 'F_PLAYER_STATS__PLAYER__NAME_SeeMore',
					controller: 'STATS',
					action: 'F_PLAYER_STATS_PlayerValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-f-player-stats-player-name',
				dismissAction: this.close,
				returnElement: 'F_PLAYER_STATS__PLAYER__NAME_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-f-player-stats-player-name')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'F_player_stats_PlayerValName',
							serverMode: true,
						...
						uuid: 'F_player_stats_F_player_stats_PlayerValName',
