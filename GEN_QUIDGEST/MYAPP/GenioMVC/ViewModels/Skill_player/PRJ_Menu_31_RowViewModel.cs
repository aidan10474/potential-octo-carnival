...
public class PRJ_Menu_31_RowViewModel : Models.Skill_player
{
	#region Constructors

	public PRJ_Menu_31_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public PRJ_Menu_31_RowViewModel(UserContext userContext, CSGenioAskill_player val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
