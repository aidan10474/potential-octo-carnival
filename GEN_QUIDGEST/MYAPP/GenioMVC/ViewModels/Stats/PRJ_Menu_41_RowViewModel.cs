...
public class PRJ_Menu_41_RowViewModel : Models.Stats
{
	#region Constructors

	public PRJ_Menu_41_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public PRJ_Menu_41_RowViewModel(UserContext userContext, CSGenioAstats val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
