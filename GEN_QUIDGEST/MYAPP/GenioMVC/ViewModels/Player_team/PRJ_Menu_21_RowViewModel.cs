...
public class PRJ_Menu_21_RowViewModel : Models.Player_team
{
	#region Constructors

	public PRJ_Menu_21_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public PRJ_Menu_21_RowViewModel(UserContext userContext, CSGenioAplayer_team val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
