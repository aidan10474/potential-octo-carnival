...
public class F_player_team_PlayerValName_RowViewModel : Models.Player
{
	#region Constructors

	public F_player_team_PlayerValName_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public F_player_team_PlayerValName_RowViewModel(UserContext userContext, CSGenioAplayer val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
