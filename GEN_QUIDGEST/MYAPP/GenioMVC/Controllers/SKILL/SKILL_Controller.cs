...
// USE /[MANUAL PRJ INCLUDE_CONTROLLER SKILL]/

namespace GenioMVC.Controllers
{
	public partial class SkillController : ControllerBase
	{
		private IChatbotService _aiService;
		public SkillController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL PRJ CONTROLLER_NAVIGATION SKILL]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAskill>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL PRJ MANUAL_CONTROLLER SKILL]/
		...
		{
			return base.GetDocumsTickets("SKILL", requestModel.FieldName, requestModel.KeyValue);
		}
