...
// USE /[MANUAL PRJ INCLUDE_CONTROLLER TEAM]/
...
namespace GenioMVC.Controllers
{
	public partial class TeamController : ControllerBase
	{
		...
		public TeamController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL PRJ CONTROLLER_NAVIGATION TEAM]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAteam>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL PRJ MANUAL_CONTROLLER TEAM]/
		...
		{
			return base.GetDocumsTickets("TEAM", requestModel.FieldName, requestModel.KeyValue);
		}
