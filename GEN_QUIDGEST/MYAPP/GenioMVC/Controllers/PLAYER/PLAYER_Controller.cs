...
namespace GenioMVC.Controllers
{
	public partial class PlayerController : ControllerBase
	{
		...
		public PlayerController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL PRJ CONTROLLER_NAVIGATION PLAYER]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAplayer>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
...
// USE /[MANUAL PRJ MANUAL_CONTROLLER PLAYER]/
		...
		{
			return base.GetDocumsTickets("PLAYER", requestModel.FieldName, requestModel.KeyValue);
		}
