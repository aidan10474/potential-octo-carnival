...
namespace CSGenio.framework
{
	...
	public class Role
	{
        ...
        public static readonly Role ROLE_12; //User
        //Roles
		...
		static Role()
		{
            ...
            ROLE_12 = new Role(LevelAccess.NV12, "USER57012");
			...
			MODULE_ROLES = [
				new("PRJ", Role.UNAUTHORIZED),

				new("PRJ", Role.ROLE_1),
				new("PRJ", Role.ROLE_12),
				new("PRJ", Role.ADMINISTRATION)			];
