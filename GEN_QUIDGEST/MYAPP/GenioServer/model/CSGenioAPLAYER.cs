...
namespace CSGenio.business
{
	...
	/// Players
	/// </summary>
	public class CSGenioAplayer : DbArea
	{
		/// <summary>
		...
		public CSGenioAplayer(User user, string module)
		{
            this.user = user;
            this.module = module;
			// USE /[MANUAL PRJ CONSTRUTOR PLAYER]/
		}

		public CSGenioAplayer(User user) : this(user, user.CurrentModule)
		{
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.AreaDesignation="Players";
			info.AreaPluralDesignation="Players";
			info.DescriptionCav="PLAYERS11892";
		...
		private static FieldRef m_fldCodplayers = new FieldRef("player", "codplayers");

		/// <summary>Field : "" Tipo: "+" Formula:  ""</summary>
		public string ValCodplayers
		{
		...
		private static FieldRef m_fldName = new FieldRef("player", "name");
        ...
        public static CSGenioAplayer search(PersistentSupport sp, string key, User user, string[] fields = null, bool forUpdate = false)
        {
			if (string.IsNullOrEmpty(key))
				return null;

		    CSGenioAplayer area = new CSGenioAplayer(user, user.CurrentModule);
        ...
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static List<CSGenioAplayer> searchList(PersistentSupport sp, User user, CriteriaSet where, string[] fields = null, bool distinct = false, bool noLock = false)
        {
				return sp.searchListWhere<CSGenioAplayer>(where, user, fields, distinct, noLock);
        }
        ...
        /// <returns>A list of area records with all fields populated</returns>
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static void searchListAdvancedWhere(PersistentSupport sp, User user, CriteriaSet where, ListingMVC<CSGenioAplayer> listing)
        {
			sp.searchListAdvancedWhere<CSGenioAplayer>(where, listing);
        }
